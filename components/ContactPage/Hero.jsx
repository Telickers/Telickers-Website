...
export default function ContactHero() {
  return (
    <section className="radial-bg flex h-screen flex-col items-center justify-center text-white lg:items-start lg:px-32">
      <h1 className="bg-[radial-gradient(138.06%_1036.51%_at_95.25%_-2.54%,_#7ED4FD_14.06%,#709DF7_51.02%,#4D78EF_79.09%)] bg-clip-text text-left text-5xl font-bold text-transparent sm:text-6xl md:text-7xl lg:text-8xl">
        GET IN TOUCH
      </h1>
